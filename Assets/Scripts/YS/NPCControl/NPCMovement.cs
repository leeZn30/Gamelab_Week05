...
public class NPCMovement : MonoBehaviour
{
    ...
    public float chaseDistance = 10.0f;  // 쫓아가는 거리
    public float fleeDistance = 5.0f;    // 도망가는 거리
    public float wanderDistance = 15.0f; // 랜덤 이동 거리
    ...
    void Start()
    {
        ...
        currentState = NPCState.Wander; // 기본 상태를 Wander(랜덤 이동)로 설정
    ...
    void Chase()
    {
        targetPosition = playerTransform.position;  // 플레이어를 목표로 설정
    }
    void Flee()
    {
